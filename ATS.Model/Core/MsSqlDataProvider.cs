...
namespace ATS.Model
{
    ...
    /// </summary>
    public partial class MsSqlFAADDataProvider : BaseDataProvider, IATSDataProvider
    {
        #region Utils
        ...
        public virtual string BuildConnectionString(IATSConnectionStringInfo nopConnectionString)
        {
